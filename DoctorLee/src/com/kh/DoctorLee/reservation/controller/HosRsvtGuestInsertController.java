...
/**
 * Servlet implementation class HosRsvtGuestInsertController
 */
@WebServlet("/guestRsvt.dy")
public class HosRsvtGuestInsertController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HosRsvtGuestInsertController() {
        super();
