...
CREATE TABLE  TB_QUIZ_BOARD  (
    QUIZ_NO    NUMBER   NOT NULL,
    QUIZ_TITLE    VARCHAR2(150)   NOT NULL,
    QUIZ_CONTENT    VARCHAR2(2000)   NOT NULL,
...
ALTER TABLE  TB_QUIZ_BOARD  ADD CONSTRAINT  PK_TB_QUIZ_BOARD  PRIMARY KEY (
	 QUIZ_NO 
);
...
REFERENCES  TB_QUIZ_BOARD  (
	 QUIZ_NO 
);

ALTER TABLE  TB_QUIZ_CHOICE  ADD CONSTRAINT  FK_TB_MEMBER_TO_TB_QUIZ_CHOICE_1  FOREIGN KEY (
	 MEM_NO 
);
REFERENCES  TB_MEMBER  (
	 MEM_NO 
...
SELECT    
         ...
         , VIEWS
         , BOARD_CONTENT
         , (SELECT COUNT(*) FROM TB_LIKE WHERE BOARD_NO = 2) AS LIKES
         , (SELECT COUNT(*) FROM TB_COMMENT WHERE BOARD_NO = 2) AS COMMENTS
         , B.STATUS
...
INSERT INTO TB_COMMENT (COMMENT_NO, BOARD_NO, WRITER, COMMENT_CONTENT, CREATE_DATE, STATUS)
VALUES (SEQ_COMMENT_NO.NEXTVAL, 4, 2, '댓글 내용입니다1.', SYSDATE, 'Y');

INSERT INTO TB_COMMENT (COMMENT_NO, BOARD_NO, WRITER, COMMENT_CONTENT, CREATE_DATE, STATUS)
VALUES (SEQ_COMMENT_NO.NEXTVAL, 4, 2, '댓글 내용입니다2.', SYSDATE, 'Y');

INSERT INTO TB_COMMENT (COMMENT_NO, BOARD_NO, WRITER, COMMENT_CONTENT, CREATE_DATE, STATUS)
VALUES (SEQ_COMMENT_NO.NEXTVAL, 4, 2, '댓글 내용입니다3.', SYSDATE, 'Y');

INSERT INTO TB_COMMENT (COMMENT_NO, BOARD_NO, WRITER, COMMENT_CONTENT, CREATE_DATE, STATUS)
VALUES (SEQ_COMMENT_NO.NEXTVAL, 4, 2, '댓글 내용입니다4.', SYSDATE, 'Y');

commit;


INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 1 제목입니다', '퀴즈 1 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-09-01', 'YYYY-MM-DD'), TO_DATE('2023-09-10', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');
INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 2 제목입니다', '퀴즈 2 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-09-02', 'YYYY-MM-DD'), TO_DATE('2023-09-11', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');
INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 3 제목입니다', '퀴즈 3 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-09-03', 'YYYY-MM-DD'), TO_DATE('2023-09-12', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');
INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 4 제목입니다', '퀴즈 4 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-09-04', 'YYYY-MM-DD'), TO_DATE('2023-09-13', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');
INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 5 제목입니다', '퀴즈 5 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-09-05', 'YYYY-MM-DD'), TO_DATE('2023-09-14', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');

INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(1, 1, '1번이 답입니다~~~~');
INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(2, 2, '2번이 답입니다~~~~');
INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(3, 3, '3번이 답입니다~~~~');
INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(4, 4, '4번이 답입니다~~~~');
INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(5, 3, '3번이 답입니다~~~~');

INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 6 제목입니다', '퀴즈 6 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-10-01', 'YYYY-MM-DD'), TO_DATE('2023-11-10', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');
INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 7 제목입니다', '퀴즈 7 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-10-02', 'YYYY-MM-DD'), TO_DATE('2023-11-11', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');
INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 8 제목입니다', '퀴즈 8 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-10-03', 'YYYY-MM-DD'), TO_DATE('2023-11-12', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');
INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 9 제목입니다', '퀴즈 9 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-10-04', 'YYYY-MM-DD'), TO_DATE('2023-11-13', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');
INSERT INTO TB_QUIZ_BOARD (QUIZ_NO, QUIZ_TITLE, QUIZ_CONTENT, VOTE, CREATE_DATE, END_DATE, CHOICE1, CHOICE2, CHOICE3, CHOICE4) VALUES (SEQ_QUIZ_NO.NEXTVAL, '퀴즈 10 제목입니다', '퀴즈 10 내용입니다~~~~~~~~~~~~ ',0, TO_DATE('2023-10-05', 'YYYY-MM-DD'), TO_DATE('2023-11-14', 'YYYY-MM-DD'), '1입니다~~~~', '2입니다~~~~', '3입니다~~~~', '4입니다~~~~');

INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(6, 2, '2번이 답입니다~~~~');
INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(7, 1, '1번이 답입니다~~~~');
INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(8, 2, '2번이 답입니다~~~~');
INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(9, 3, '3번이 답입니다~~~~');
INSERT INTO TB_QUIZ_ANSWER (QUIZ_NO, ANSWER, ANSWER_DETAIL) VALUES(10, 4, '4번이 답입니다~~~~');
